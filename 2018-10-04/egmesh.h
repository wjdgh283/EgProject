...
public:
	...
	/*! \brief 정점 리스트의 이전 정점에 대한 포인터 */
	EgVertex *m_pPrev;

	/*! \brief 정점 리스트의 다음 정점에 대한 포인터 */
	EgVertex *m_pNext;
...
public:
	...
	/*! \brief 텍셀 리스트의 이전 텍셀에 대한 포인터 */
	EgTexel *m_pPrev;

	/*! \brief 텍셀 리스트의 다음 텍셀에 대한 포인터 */
	EgTexel *m_pNext;
...
public:
	...
	/*! \brief 법선 리스트의 이전 법선에 대한 포인터 */
	EgNormal *m_pPrev;

	/*! \brief 법선 리스트의 다음 법선에 대한 포인터 */
	EgNormal *m_pNext;
...
public:
	...
	/*! \brief 에지의 시작 텍셀에 대한 포인터 */
	EgTexel *m_pTexel;

	/*! \brief 에지의 시작 법선에 대한 포인터 */
	EgNormal *m_pNormal;
...
public:
	...
	/*! \brief 삼각형 리스트의 이전 삼각형에 대한 포인터 */
	EgFace *m_pPrev;

	/*! \brief 삼각형 리스트의 다음 삼각형에 대한 포인터 */
	EgFace *m_pNext;
...
public:
	...
	/*! \brief 재질 리스트의 이전 재질에 대한 포인터 */
	EgMaterial *m_pPrev;

	/*! \brief 재질 리스트의 다음 재질에 대한 포인터 */
	EgMaterial *m_pNext;
